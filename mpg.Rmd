...
```
Bu doküman istatistik dersinde öğrencilerin yapacakları projelerde  faaliyetler hazırlaması konusunda nlerin farklı araç tiplerinin yakıt tüketimleri ilgili istatistiksel analizler yapılacaktır.
Bu amaçla hazır veri setlerinden **mpg** veri seti kullanılmıştır. Bu veri seti 1999-2008 yılları arasında üretilen otomobillerin yakıt ekonomisi ile ilgili verileri içermektedir.

# Projenin Konusu ve Amacı

istatistik dersinde projelerde yapılacak faaliyetler  hazırlaması konusunda nlerin farklı araç tiplerinin yakıt tüketimleri ilgili istatistiksel analizler yapılacaktır. 
